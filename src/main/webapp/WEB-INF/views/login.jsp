...
<body style="background-image:url('<c:url
        value="/resources/images/login-background.jpg"/>');background-size: cover;">
<div class="container">
    <div class="container form bg-white pt-5 mt-4 mb-3">
        ...
        <div class="container hide-me">
            ...
            <div class="row mt-4">
                <div class="col pl-5 pr-5">
                    <span class="btn btn-block text-white login-button"><input type="submit" name="Submit" class="btn btn-default"/></span>
                </div>
            </div>
            </form>
        ...
        <div class="row mt-4 show-me">
            <div class="col pl-5 pr-5">
                <a href=""><span class="btn btn-block text-white signup-button">sign up</span></a>
            </div>
        </div>
